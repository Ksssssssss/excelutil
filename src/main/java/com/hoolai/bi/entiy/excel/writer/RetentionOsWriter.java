...
@Component
public class RetentionOsWriter extends Writer {
    ...
    public ExcelDatas produceDatas(QueryInfo info) {
        ExcelDatas dailyStatsDatas = retentionOsServiceImpl.produceDatas(info.getStartDs(),info.getEndDs(),info.getGameid());;
