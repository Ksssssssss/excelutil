...
@Component
public class RetentionWriter extends Writer {
    ...
    public ExcelDatas produceDatas(QueryInfo info) {
        ExcelDatas dailyStatsDatas = retentionServiceImpl.produceDatas(info.getStartDs(),info.getEndDs(),info.getGameid());;
