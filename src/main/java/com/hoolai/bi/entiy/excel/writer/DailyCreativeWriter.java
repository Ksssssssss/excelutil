...
@Component
public class DailyCreativeWriter extends Writer {
    ...
    public ExcelDatas produceDatas(QueryInfo info) {
        ExcelDatas dailyStatsDatas = dailyCreativeStatsServiceImpl.produceDatas(info.getStartDs(),info.getEndDs(),info.getGameid());;
